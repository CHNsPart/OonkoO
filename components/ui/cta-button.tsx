...
>) {
  ...
  return (
    <Tag
      ...
      className={cn(
        "relative flex rounded-full border content-center bg-black/20 hover:bg-brand-primary/10 transition duration-500 items-center flex-col flex-nowrap gap-10 h-min justify-center overflow-visible p-px decoration-clone w-fit",
        containerClassName
      )}
      {...props}
    >
      <div
        className={cn(
          "w-auto text-white z-10 bg-black px-6 py-2 rounded-[inherit]",
