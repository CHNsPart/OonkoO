...
import { ArrowRight, Sparkles, Star, Code2, Smartphone, Palette, Globe2, BarChart3, Cloud } from 'lucide-react';
...
export default function CTABottom() {
  ...
  const isVideoInView = useInView(videoRef, { once: false, margin: "-100px" });
  ...
  return (
    <section 
      ref={containerRef}
      className="relative min-h-screen w-full overflow-hidden py-16 sm:py-24 lg:py-32 z-[1]"
    >
