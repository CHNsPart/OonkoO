// Path: components/pages/products.tsx
...
const products = [
  ...
  },
  {
    ...
    description: "A scalable dashboard solution that enables administrators to manage multiple tenant accounts, providing real-time insights and analytics for each.",
    cursorImage: "/products/ad-iq.png",
    previewImage: "/products/ad-iq.png",
    location: "International",
    category: "Enterprise Solutions",
    tags: ["IoT", "Real-time", "Dashboard"],
    link: "/case-study/ad-iq"
  },
  {
    id: 4,
